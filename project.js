...
newButton.addEventListener("click", function() {redirectTo("./add.html")});
menuButton.addEventListener("click", function() {redirectTo("./index.html")});
...
var config = {
    apiKey: "AIzaSyDc0HfZ2h03fdfGBAVX7kZgsdUiT4x5KZI",
    authDomain: "is445-courseproject.firebaseapp.com",
    databaseURL: "https://is445-courseproject.firebaseio.com",
    projectId: "is445-courseproject",
    storageBucket: "is445-courseproject.appspot.com",
    messagingSenderId: "703401890651"
};
...
function buttonUpdate()
{
    ...
    {
        chargeTable();
        blurButton(newButton);
    }
    else if (path === "add.html")
        blurButton(menuButton);
    else 
    {
        blurButton(menuButton);
        blurButton(newButton);
